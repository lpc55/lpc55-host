    ...
    let app = App::new("lpc55")
        ...
        .subcommand(SubCommand::with_name("configure")
            ...
            .subcommand(SubCommand::with_name("customer-settings")
                ...
                .arg(Arg::with_name("no-overwrite")
                     .help("Do not overwrite firmware versions, PRINCE IV's, or reserved areas of customer PFR.")
                     .short("s")
                     .long("no-overwrite")
                     .takes_value(false)
                )
                .arg(Arg::with_name("auto-increment")
                     .short("a")
                     .long("auto-increment")
                     .help("Increment customer version number as needed to make PFR write.")
                     .takes_value(false)
                )
        ...
        .subcommand(SubCommand::with_name("write-memory")
            ...
            .arg(Arg::with_name("INPUT")
                 .help("Sets the input file to use. TODO: read from stdin if missing")
                 .short("i")
                 .long("input-file")
                 .required(true)
                 .takes_value(true))
        ...
        .subcommand(SubCommand::with_name("write-flash")
            .version(crate_version!())
            .long_version(LONG_VERSION.as_str())
            .about("write to flash (like write-memory, but erases first)")
            .arg(Arg::with_name("ADDRESS")
                 .help("Address to start writing to")
                 .required(true))
            .arg(Arg::with_name("INPUT")
